...
--Key
wait(0.1)
AlchemyNotify("Thanks for using Kazochim Hub!",5)
wait(0.1)
AlchemyNotify("discord.gg/kazochim",5)
wait(0.5)
local Notification = require(game:GetService("ReplicatedStorage").Notification)
Notification.new("<Color=Cyan>Kazochim Hub V2 Script<Color=/>"):Display()
wait(0.5)
Notification.new("<Color=Yellow>Create By Kazochim<Color=/>"):Display()
wait(1)
repeat
    wait()
...
HomePage:Seperator("Kazochim Hub")
...
HomePage:Button("Copy Discord Link", function()
    ...
    setclipboard("https://discord.gg/Kazochim")
end)
-----------------------------------------------------------------------------------------------------------------------------Function
